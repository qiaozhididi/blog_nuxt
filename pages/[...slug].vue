            ...
            <section :data-slug="slide.cover?.slug" :style="{ background: slide.cover?.backgroundColor || '#111827' }">
              <div class="slide-content-wrapper">
                ...
                <div class="mt-8 md:mt-12 animate-bounce text-gray-500">
                  <Icon name="chevron-down" class="text-2xl md:text-3xl" />
                </div>
              </div>
            </section>
                ...
                <div class="flex flex-col lg:flex-row items-center justify-center gap-6 lg:gap-16 max-w-7xl mx-auto p-4 w-full min-h-screen lg:h-full lg:overflow-hidden">
                  ...
                  <div class="w-full lg:flex-1 flex justify-center items-center min-w-0">
                     <div class="relative group w-full max-w-[280px] md:max-w-md">
                       ...
                       <img :src="resolvePath(item.image)" :alt="item.title" loading="lazy" decoding="async" class="relative w-full rounded-xl shadow-2xl object-cover transform transition duration-500 hover:scale-[1.02]" />
                     </div>
                  </div>
                  ...
                  <div class="w-full lg:flex-1 text-center lg:text-left flex flex-col justify-center min-w-0">
                    <div class="flex items-center justify-center lg:justify-start gap-3 md:gap-4 mb-4 md:mb-6">
                      <div class="p-2 md:p-3 bg-gray-800 rounded-full shadow-lg">
                          <Icon :name="item.icon" class="text-2xl md:text-3xl text-purple-400" />
                      </div>
          ...
          <div v-else-if="slide.type === 'contact'" class="slide-content-wrapper">
            ...
            <div class="flex justify-center gap-6 md:gap-8 mb-12 md:mb-16">
              <a v-for="(link, lIndex) in slide.socialLinks" :key="lIndex" :href="link.href" :aria-label="link.name" target="_blank" class="text-gray-400 hover:text-white transition transform hover:scale-110">
                <Icon :name="link.icon" class="text-4xl md:text-5xl" />
              </a>
            </div>
